...
20.7 打开 `G:\AVScope\samples\sample_rtcp_twcc.pcap`，进入“传输会话 / 拥塞反馈”，确认 1 个 TWCC 反馈、Base Sequence 1000、5 个状态、收到 4、丢失 1、反馈计数 7、最大 Delta 30 ms；逐包表应显示序号 1002 未接收、序号 1003 Large Delta 30 ms。双击反馈或逐包行应定位 Hex。HTML 应包含“RTCP TWCC 拥塞反馈”，CSV 应包含 `rtcp_twcc` 和 `rtcp_twcc_packet`。
