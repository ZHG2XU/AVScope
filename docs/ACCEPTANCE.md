...
32. 打开 `G:\AVScope\dist\sample-reports\sample_wav_report.html`、`sample_mp4_report.json`、`sample_rtp_video_report.html` 和 `sample_sip_sdp_report.html`，确认交付目录包含文件、封装、RTP 视频负载及 SIP/SDP 示例分析报告。
