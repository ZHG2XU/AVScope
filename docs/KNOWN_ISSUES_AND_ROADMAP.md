...
- PCAP/RTP/RTCP 当前支持按端点与 SSRC 聚合会话、sequence 回绕、估算丢包/重复/乱序、marker 和 payload 码率，支持 RTCP Compound、SR/RR 与 Report Block、H.264/H.265 Single/Aggregation/FU 视频负载，以及 SIP/SDP 动态 PT 与 Clock Rate 关联；暂未解析 SDES/BYE/反馈包，也未扩展到 RTSP/GB28181 专用信令和 TCP SIP 重组。
