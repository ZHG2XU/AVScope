...
VALIDATED_CHECKS = [
    "Qt 6/C++20 UI build smoke test",
    "Qt dark/light theme Windows screenshot and high-DPI smoke test",
    "Qt protocol tree full field/value data contract smoke test",
    "Qt RTCP protocol tree and session quality preview smoke test",
    "Qt RTP/RTCP transport session table, anomaly filter and Hex offset contract smoke test",
    "Qt RTP H.264/H.265 payload, aggregation, fragmentation and NALU table smoke test",
    "Qt SIP/SDP Call-ID, media negotiation and port-scoped dynamic PT mapping smoke test",
    "Qt RTCP NACK/PLI/FIR, SDES/BYE control feedback and SSRC session link smoke test",
    "Qt RTP RFC 3550 jitter, arrival interval, timing deviation and burst event smoke test",
    "Qt WebRTC RTCP TWCC packet status, receive delta and congestion feedback smoke test",
    "Qt H.264/H.265 codec health page, dark/light theme and Hex offset contract smoke test",
    "Deployed Qt UI and bundled AVScopeEngine sidecar smoke test",
    ...
    "UI/报告源码乱码扫描",
    "PCAP/RTP sequence 与 RTCP SR/RR、Report Block、会话质量报告冒烟测试",
    "RTP transport session loss, duplicate, reorder, wraparound and HTML/CSV export smoke test",
    "RTP H.264/H.265 STAP-A/AP/FU reassembly diagnostics and report export smoke test",
    "SIP/SDP header, media, rtpmap/fmtp, clock-rate and RTP session association smoke test",
    "RTCP SDES/BYE, Generic NACK loss expansion, PLI/FIR and HTML/CSV report smoke test",
    "RTP timing quality, static/SDP clock rate and burst offset report smoke test",
